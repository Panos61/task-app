...
import { Button, Divider, Input, Skeleton } from '@mantine/core';
...
export const Overview = () => {
  ...
  const cardCls =
    'flex flex-col gap-12 w-[500px] p-20 border border-gray-400/20 rounded-12';

  return (
    <div className='flex flex-col items-center gap-32 h-full mxx-24'>
      ...
      <div className='flex items-center gap-12'>
        {overviewLoading ? (
          <Skeleton w={500} h={200} animate={false} />
        ) : (
